...
- __Enquiries__ - The background image within the enquiries page was unresponsive based on device size. Although this was resolved, there are still some issues on certain devices, where the height does not match the screen size.
